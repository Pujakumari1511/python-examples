...
class Body(Tag):
    ...
    def __init__(self):
        super().__init__('body', '')   # body contents will be built up saaretly
        self._body_contents = []
...
if __name__ == "__main__":
    ...
    new_body = Body()
    new_body.add_tag('h1', 'Aggreation')
    new_body.add_tag('p', "Unlike <strong>composition</strong>, aggreation uses existing instances"
    ...
    new_docType = DocType()
    new_header = Head('Aggreation Document')
